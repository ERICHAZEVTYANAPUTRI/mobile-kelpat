...
import 'package:mobileflutterkelompok4/components/user/halamanaboutusercomponent.dart';
...
class abouteuserscreen extends StatelessWidget {
  static String routeName = "/aboute_User";
  static var dataUser;
  int index = 0;
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: halamanabouteusercomponent(),
