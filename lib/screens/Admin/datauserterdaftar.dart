...
import 'package:mobileflutterkelompok4/components/admin/userterdaftarconponent.dart';
...
class userterdaftarscreen extends StatelessWidget {
  static var routeName = "/User_Terdaftar";
  int index = 0;
